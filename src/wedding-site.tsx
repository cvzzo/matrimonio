...
// ============================================================
// TODO: Imposta la data esatta del matrimonio
// ============================================================
const WEDDING_DATE = new Date("2027-06-20T15:00:00");

// ============================================================
// TODO: Sostituisci con la tua Google Maps Embed API key
//       e le coordinate / place_id della venue.
//       Guida: https://developers.google.com/maps/documentation/embed/get-started
// ============================================================
const MAPS_EMBED_URL =
  "https://www.google.com/maps/embed?pb=TODO_INCOLLA_QUI_IL_TUO_EMBED_URL";

// ============================================================
// TODO: Sostituisci con il link Google Maps diretto per la
//       navigazione (es. https://goo.gl/maps/XXXXXX)
// ============================================================
const MAPS_DIRECTIONS_URL = "https://maps.google.com/?q=TODO_INDIRIZZO_VENUE";

// ============================================================
// TODO: Nome e indirizzo leggibile della venue
// ============================================================
const VENUE_NAME = "TODO — Nome della venue";
const VENUE_ADDRESS = "TODO — Via, Città, CAP";

// ============================================================
// TODO: Percorso del video hero (es. "/video/hero.mp4")
//       Decommentare il tag <video> nella funzione HeroSection
// ============================================================
const HERO_VIDEO_SRC = "/TODO_percorso_video.mp4";
...
function useCountdown(targetDate: Date): CountdownTime {
  const [timeLeft, setTimeLeft] = useState<CountdownTime>({ giorni: 0, ore: 0, minuti: 0, secondi: 0 });
  useEffect(() => {
    const calc = () => {
      const diff = targetDate.getTime() - Date.now();
      if (diff <= 0) return setTimeLeft({ giorni: 0, ore: 0, minuti: 0, secondi: 0 });
      setTimeLeft({
...
const styles = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .ws-texture-section::before {
    ...
    background: rgba(248,246,242,0.88); z-index: 0;
  }
  .ws-texture-section > * { position: relative; z-index: 1; }

  /* COUNTDOWN */
  .ws-countdown { padding: 5rem 2rem 4rem; text-align: center; }
  .ws-section-label {
    font-family: 'Montserrat', sans-serif;
  ...
  .ws-countdown-item { text-align: center; }
  .ws-countdown-num {
  ...
  .ws-letter-signature { font-family: 'Great Vibes', cursive; font-size: 2.2rem; color: #7a6050; margin-top: 1rem; text-align: center; }
  ...
  .ws-flowers img { width: 100%; max-width: 900px; object-fit: contain; display: block; }

  /* OTHER PAGES */
  .ws-page { min-height: 100vh; padding: 8rem 2rem 4rem; max-width: 800px; margin: 0 auto; }
  .ws-page-title {
    font-family: 'Great Vibes', cursive; font-size: clamp(2.5rem, 8vw, 4rem);
    color: #5a4a3a; text-align: center; margin-bottom: 0.5rem;
  }
  .ws-page-sub {
...
function FlowerDecoration() {
  return (
    <div className="ws-flowers">
      {/* TODO: Sostituisci con l'immagine dei fiori caricata localmente (/flowers.png) */}
      <img
        src="https://images.unsplash.com/photo-1490750967868-88df5691cc5f?w=1200&q=70"
...
// ---- MAP SECTION ----
function MapSection() {
  // TODO: Quando hai l'URL embed, rimuovi il blocco "isPlaceholder" e tieni solo l'iframe
  const isPlaceholder = MAPS_EMBED_URL.includes("TODO");
  ...
  return (
    <section className="ws-map-section">
      ...
      <div className="ws-map-iframe-wrap">
        {isPlaceholder ? (
          // TODO: Rimuovi questo blocco quando aggiungi MAPS_EMBED_URL reale
          <div className="ws-map-placeholder">
            <span>📍 Mappa — in attesa dell'URL embed</span>
            <span style={{ fontSize: "0.65rem", opacity: 0.7 }}>
              Sostituisci MAPS_EMBED_URL in cima al file
            </span>
          </div>
        ) : (
          <iframe
      ...
      <div style={{ textAlign: "center" }}>
        {/* TODO: Verifica che MAPS_DIRECTIONS_URL sia il link corretto prima di pubblicare */}
        <a
  ...
  return (
    <div>
      ...
      <section className="ws-hero">
        {/*
          TODO: Quando hai il video, decommenta il tag <video> qui sotto
                e rimuovi il div .ws-hero-placeholder.
                Assicurati che il file sia in /public/TODO_percorso_video.mp4
        */}
        {/* <video autoPlay muted loop playsInline>
          <source src={HERO_VIDEO_SRC} type="video/mp4" />
        </video> */}

        {/* TODO: Rimuovi questo div quando aggiungi il video */}
        <div className="ws-hero-placeholder">
          <p className="ws-hero-placeholder-text">
            TODO — Sostituire con video hero (loop, autoplay, muted)
          </p>
        </div>
      ...
      <div className="ws-texture-section">
        {/* COUNTDOWN */}
        <section className="ws-countdown">
          ...
          <div className="ws-countdown-grid">
            {(
              ...
              <span
                key={item.label}
                style={{ display: "flex", alignItems: "flex-start", gap: "clamp(1rem,4vw,3rem)" }}
              >
        ...
        <section className="ws-story">
          ...
          {/*
            TODO: Modifica il testo qui sotto con la vostra storia completa.
                  Puoi aggiungere o rimuovere paragrafi <p> a piacimento.
          */}
          <div className="ws-letter">
            <p>
              La nostra storia è iniziata nel 2015 tra i banchi di scuola. Eravamo il giorno
              e la notte. In poco tempo, senza neanche rendercene conto, ci siamo innamorati
              e la luce del giorno ha iniziato a illuminare anche la notte più buia.
            </p>
            <p>
...
function StoriaPage() {
  return (
    <div className="ws-texture-section" style={{ minHeight: "100vh" }}>
      <div className="ws-page">
        <h1 className="ws-page-title">La Nostra Storia</h1>
        {/* TODO: Stesso testo della home — aggiorna entrambi se modifichi */}
        <div className="ws-letter">
          <p>La nostra storia è iniziata nel 2015 tra i banchi di scuola. Eravamo il giorno e la notte. In poco tempo, senza neanche rendercene conto, ci siamo innamorati e la luce del giorno ha iniziato a illuminare anche la notte più buia.</p>
          <p>Ne abbiamo passate tante, attimi meravigliosi e momenti indimenticabili. Anche se a volte il nostro cammino è stato tortuoso, noi siamo sempre rimasti uniti e abbiamo superato ogni difficoltà insieme.</p>
          <p>Il primo grande passo l'abbiamo fatto nel 2022, andando a vivere insieme e iniziando così a costruire la nostra famiglia. Poco meno di un anno dopo è arrivata Nala, la nostra cagnolina.</p>
          <p>Dieci anni dopo il nostro primo bacio, il 3 novembre 2025, è arrivata la proposta tanto attesa. Siamo pronti a scrivere insieme il resto della nostra storia.</p>
        </div>
        <div className="ws-letter-signature">Silvia &amp; Davide</div>
        <FlowerDecoration />
      </div>
  ...
  return (
    <div className="ws-texture-section" style={{ minHeight: "100vh" }}>
      <div className="ws-page">
        ...
        <p className="ws-page-sub">Conferma la tua presenza entro il TODO — data limite</p>
        <div className="ws-form">
          ...
          <textarea rows={3} placeholder="Scrivi qui eventuali intolleranze o allergie..." />
...
const PROGRAMMA_ITEMS = [
  ...
  { time: "14:30", title: "Accoglienza degli ospiti", desc: "Vi aspettiamo nel giardino della villa per un aperitivo di benvenuto." },
  { time: "15:30", title: "Cerimonia", desc: "TODO — aggiungere tipo di cerimonia (civile/religiosa) e luogo esatto" },
  { time: "16:30", title: "Cocktail & Foto", desc: "Festeggiamo insieme con un aperitivo all'aperto mentre i nostri fotografi immortalano i momenti." },
  { time: "19:30", title: "Cena", desc: "TODO — aggiungere dettagli venue e menu" },
  { time: "23:00", title: "Taglio della torta", desc: "Il momento più dolce della serata, da condividere con tutti voi." },
  { time: "23:30", title: "Festa & Balli", desc: "La musica ci accompagnerà fino a notte fonda — preparatevi a ballare!" },
];
  ...
  return (
    <div className="ws-texture-section" style={{ minHeight: "100vh" }}>
      <div className="ws-page">
        ...
        {/* TODO: Inserisci nome e indirizzo della venue */}
        <div className="ws-placeholder-block" style={{ marginBottom: "3rem" }}>
          <p>📍 TODO — Nome venue · Via, Città</p>
        </div>
    ...
    <div className="ws-texture-section" style={{ minHeight: "100vh" }}>
      <div className="ws-page">
        ...
        <div className="ws-lm-grid">
          {[
            { label: "Destinazione", todo: "TODO — es. Maldive, Giappone, Polinesia…" },
            { label: "Periodo", todo: "TODO — es. Luglio 2027" },
            { label: "Wishlist", todo: "TODO — esperienze e attività desiderate" },
            { label: "Come contribuire", todo: "TODO — link lista nozze o istruzioni bonifico" },
          ].map(({ label, todo }) => (
            <div className="ws-lm-card" key={label}>
              <h3>{label}</h3>
              <p style={{ color: "#b09070", fontStyle: "italic", fontSize: "0.9rem" }}>{todo}</p>
            </div>
          ))}
        </div>
...
const FAQS = [
  ...
  { q: "Dove si svolge il matrimonio?", a: "TODO — aggiungere indirizzo completo e indicazioni stradali" },
  { q: "C'è un dress code?", a: "TODO — es. Elegante / Smart casual / Tema colore specifico" },
  { q: "Ci sono opzioni per i bambini?", a: "TODO — indicare se i bambini sono invitati e se ci sono servizi dedicati" },
  { q: "Come arrivo alla venue?", a: "TODO — indicazioni, parcheggio disponibile, eventuale navetta" },
  { q: "Dove posso dormire?", a: "TODO — aggiungere hotel consigliati o B&B nelle vicinanze" },
  { q: "Posso portare un +1?", a: "TODO — specificare la policy sugli accompagnatori" },
  { q: "Entro quando devo confermare la presenza?", a: "TODO — data limite RSVP" },
];
      ...
      <div className="ws-page">
        ...
        {FAQS.map((faq, i) => (
          <div className="ws-faq-item" key={i}>
            <div className="ws-faq-q" onClick={() => setOpen(open === i ? null : i)}>
              {faq.q}
              <span style={{ fontSize: "1.2rem", color: "#c9b49a" }}>{open === i ? "−" : "+"}</span>
            </div>
    ...
    <div className="ws-texture-section" style={{ minHeight: "100vh" }}>
      <div className="ws-page">
        ...
        <div style={{ textAlign: "center", marginTop: "3rem" }}>
          <p style={{ fontFamily: "'Great Vibes', cursive", fontSize: "2rem", color: "#7a6050" }}>
            Non esitare a scriverci!
          </p>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1rem", color: "#a08060", marginTop: "0.5rem" }}>
  ...
  return (
    <>
      ...
      <div className="ws-app">
        ...
        {/* ── NAV ── */}
        <nav className={`ws-nav${scrolled || page !== "home" ? " scrolled" : ""}`}>
          <div className="ws-nav-logo" onClick={() => navigate("home")}>S &amp; D</div>
          <button
        ...
        <div className={`ws-menu-overlay${menuOpen ? " open" : ""}`}>
          {NAV_ITEMS.map((item: NavItem) => (
            <a key={item.id} href="#" onClick={(e) => { e.preventDefault(); navigate(item.id); }}>
              {item.label}
            </a>
          ))}
        </div>
